...
import PdfReport.pdf.chart.ReportBarChart;
		...
		TableBuilder tableBuilder = Table.builder()
				...
				.addRow(Row.builder().font(ReportFont.BOLD_FONT).fontSize(14).borderWidth(0f).padding(7f)
						.add(TextCell.builder().colSpan(5).wordBreak(true)
								.text("(Scenario)- " + sanitizer.sanitizeText(scenario.getName()))
				...
				.addRow(Row.builder().fontSize(11).add(TextCell.builder().colSpan(5).padding(FEATURE_NAME_PADDING)
						.wordBreak(true)
				...
				.addRow(Row.builder().fontSize(11).add(TextCell.builder().colSpan(5).text(sanitizer.sanitizeText(tags))
